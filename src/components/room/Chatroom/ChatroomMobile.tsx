  ...
  return (
    <div className="flex flex-col w-full h-full border-gray-500 border-b-1">
      ...
      <form
        ...
        className="flex relative flex-grow justify-between items-center py-1.5 px-2 w-full bg-gray-50"
      >
        ...
        <div className="flex px-1 h-full">
          <button
            ...
            className="m-auto text-2xl text-amber-400 i-heroicons-paper-airplane-20-solid"
          ></button>
        </div>
      </form>
    </div>
