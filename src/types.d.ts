...
export type GET_BACCARATROOMS = { activeBaccaratRooms: Array<{ __typename: 'BaccaratRoom', id: string, name: string | null, currentRoadsImage: string | null, waitingBetSeconds: number | null, roads: any | null, latency: number | null, alertText: string | null, waitingText: string | null, zoomType: string | null, status: string | null, streamName: string | null, streamKey: string | null, girl: (
      { __typename: 'Girl' }
      & GIRL_TYPE
