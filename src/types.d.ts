...
export type Agent = SourceInterface & {
  __typename: 'Agent';
  /** 自上而下的排序名稱 */
  agentPathUsernames: Maybe<Scalars['String']>;
  agentWinLossReport: AgentWinLossReport;
  /** 所有上層 */
  ancestors: Maybe<Array<Agent>>;
  /** Auth */
  authToken: Maybe<Scalars['String']>;
  /** 可用下層帳號 */
  availableChildrenUsername: Maybe<Array<Scalars['String']>>;
  /** 可用玩家帳號 */
  availableUserUsername: Maybe<Array<Scalars['String']>>;
  /** 百家佔成 */
  baccaratShareProfitRate: Maybe<Scalars['Float']>;
  /** 百家洗碼比 */
  baccaratXimaRate: Maybe<Scalars['Float']>;
  bots: Scalars['Boolean'];
  botsFromAncestors: Scalars['Boolean'];
  /** 下層 */
  children: Maybe<Array<Agent>>;
  childrenAndUsersMaxXimaRate: Maybe<Scalars['Float']>;
  /** 下層數量 */
  childrenCount: Maybe<Scalars['Int']>;
  childrenMaxShareProfitRate: Maybe<Scalars['Float']>;
  childrenMaxXimaRate: Maybe<Scalars['Float']>;
  /** 建立時間 */
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 代理額度 */
  creditLimit: Maybe<Scalars['Float']>;
  /** 剩餘代理額度 */
  creditLimitLeft: Maybe<Scalars['Float']>;
  /** 所有下層 */
  descendants: Maybe<Array<Agent>>;
  /** 下線代理總數 */
  descendantsCount: Maybe<Scalars['Int']>;
  enableEditProfit: Maybe<Scalars['Boolean']>;
  /** 是否在介面隱藏 */
  hide: Maybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  /** 是否為子帳號 */
  isSubAccount: Maybe<Scalars['Boolean']>;
  /** 最後登入時間 */
  lastSignInAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 最後登入IP */
  lastSignInIp: Maybe<Scalars['JSON']>;
  /** 層數 */
  ...
  /** 牛牛佔成 */
  niuniuShareProfitRate: Maybe<Scalars['Float']>;
  /** 牛牛洗碼比 */
  niuniuXimaRate: Maybe<Scalars['Float']>;
  /** 備註 */
  ...
  parent: Maybe<Agent>;
  /** 母帳號 */
  parentAccount: Maybe<Agent>;
  /** 母帳號名稱 */
  parentAccountUsername: Maybe<Scalars['String']>;
  showOldReport: Maybe<Scalars['Boolean']>;
  /** 登入次數 */
  signInCount: Maybe<Scalars['Int']>;
  /** 所有子帳號 */
  subAccounts: Maybe<Array<Agent>>;
  /** 限紅組 */
  tableLimits: Maybe<Array<TableLimit>>;
  /** tree */
  tree: Maybe<Scalars['JSON']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  userWinLossReports: Array<UserWinLossReport>;
  /** 使用者名稱 */
  username: Maybe<Scalars['String']>;
  /** 下線用戶 */
  ...
  usersMaxXimaRate: Maybe<Scalars['Float']>;
  /** 破台分 */
  winLimit: Maybe<Scalars['Float']>;
  /** 退水模式 */
  ximaWay: Maybe<Scalars['String']>;
};
...
export type AgentWinLoss = {
  ...
  agent: Maybe<Agent>;
  /** 百家投注金額 */
  baccaratBetAmount: Maybe<Scalars['Float']>;
  /** 百家有效投注 */
  baccaratEffectiveAmount: Maybe<Scalars['Float']>;
  /** 百家交上線金額 */
  baccaratParentAmount: Maybe<Scalars['Float']>;
  /** 百家交上線有效投注 */
  baccaratParentEffectiveAmount: Maybe<Scalars['Float']>;
  /** 百家佔成 */
  baccaratShareProfit: Maybe<Scalars['Float']>;
  /** 百家輸贏 */
  baccaratWinLoss: Maybe<Scalars['Float']>;
  /** 百家輸贏比 */
  baccaratWinLossRate: Maybe<Scalars['String']>;
  /** 百家洗碼佣金 */
  baccaratXimaAmount: Maybe<Scalars['Float']>;
  /** 下層代理報表 */
  childrenReports: Maybe<Array<AgentWinLoss>>;
  id: Scalars['ID'];
  /** 我的收益 */
  myProfit: Maybe<Scalars['Float']>;
  /** 牛牛投注金額 */
  niuniuBetAmount: Maybe<Scalars['Float']>;
  /** 牛牛有效投注 */
  niuniuEffectiveAmount: Maybe<Scalars['Float']>;
  /** 牛牛交上線金額 */
  niuniuParentAmount: Maybe<Scalars['Float']>;
  /** 牛牛交上線有效投注 */
  niuniuParentEffectiveAmount: Maybe<Scalars['Float']>;
  /** 牛牛佔成 */
  niuniuShareProfit: Maybe<Scalars['Float']>;
  /** 牛牛輸贏 */
  niuniuWinLoss: Maybe<Scalars['Float']>;
  /** 牛牛輸贏比 */
  niuniuWinLossRate: Maybe<Scalars['String']>;
  /** 牛牛洗碼佣金 */
  niuniuXimaAmount: Maybe<Scalars['Float']>;
  /** 小計投注金額 */
  totalBetAmount: Maybe<Scalars['Float']>;
  /** 小計有效投注 */
  totalEffectiveAmount: Maybe<Scalars['Float']>;
  /** 小計交上線金額 */
  totalParentAmount: Maybe<Scalars['Float']>;
  /** 小計交上線有效投注 */
  totalParentEffectiveAmount: Maybe<Scalars['Float']>;
  /** 百家佔成 */
  totalShareProfit: Maybe<Scalars['Float']>;
  /** 總投注人數 */
  totalUsersCount: Maybe<Scalars['Int']>;
  /** 小計輸贏 */
  totalWinLoss: Maybe<Scalars['Float']>;
  /** 小計輸贏比 */
  totalWinLossRate: Maybe<Scalars['String']>;
  /** 小計洗碼佣金 */
  totalXimaAmount: Maybe<Scalars['Float']>;
  /** 玩家輸贏報表 */
  usersReports: Maybe<Array<UserWinLoss>>;
};
...
export type AgentWinLossReport = {
  ...
  /** 百家有效投注 */
  effectiveAmount: Maybe<Scalars['Float']>;
  /** 禮物 */
  giftsAmount: Maybe<Scalars['Float']>;
  id: Scalars['ID'];
  /** 百家交上線金額 */
  parentAmount: Maybe<Scalars['Float']>;
  /** 百家交上線有效投注 */
  parentEffectiveAmount: Maybe<Scalars['Float']>;
  /** 百家佔成 */
  shareProfit: Maybe<Scalars['Float']>;
  /** 總金額 */
  totalAmount: Maybe<Scalars['Float']>;
  /** 總投注人數 */
  usersCount: Maybe<Scalars['Int']>;
  /** 百家輸贏 */
  winLoss: Maybe<Scalars['Float']>;
  /** 百家輸贏比 */
  winLossRate: Maybe<Scalars['Float']>;
  /** 百家洗碼佣金 */
  ximaAmount: Maybe<Scalars['Float']>;
};
...
export type AnnoncementCollection = {
  ...
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  records: Maybe<Array<Annoncement>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type BaccaratBetRecord = BetInterface & ReferenceRecordInterface & {
  ...
  /** 房間 */
  baccaratRoom: Maybe<BaccaratRoom>;
  /** 投注編號 */
  betNo: Maybe<Scalars['String']>;
  /** 押大金額 */
  bigAmount: Maybe<Scalars['Float']>;
  /** 押大輸贏金額 */
  bigDiffAmount: Maybe<Scalars['Float']>;
  /** City */
  ...
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 派彩後餘額 */
  creditAfterWin: Maybe<Scalars['Float']>;
  /** 派彩後的輸贏餘額 */
  creditDiff: Maybe<Scalars['Float']>;
  /** 幣別 */
  currency: Maybe<Scalars['String']>;
  /** 押莊金額 */
  dealerAmount: Maybe<Scalars['Float']>;
  /** 押莊輸贏金額 */
  dealerDiffAmount: Maybe<Scalars['Float']>;
  /** 押閒對金額 */
  dealerPairAmount: Maybe<Scalars['Float']>;
  /** 押閒對輸贏金額 */
  dealerPairDiffAmount: Maybe<Scalars['Float']>;
  /** 總輸贏 */
  diff: Maybe<Scalars['Float']>;
  /** 有效投注 */
  effectiveAmount: Maybe<Scalars['Float']>;
  /** 有效投注 * 洗碼比 */
  effectiveXimaAmount: Maybe<Scalars['Float']>;
  /** 廳 */
  hall: Maybe<Hall>;
  id: Scalars['ID'];
  /** info */
  ...
  /** 押閒金額 */
  playerAmount: Maybe<Scalars['Float']>;
  /** 押閒輸贏金額 */
  playerDiffAmount: Maybe<Scalars['Float']>;
  /** 押莊對金額 */
  playerPairAmount: Maybe<Scalars['Float']>;
  /** 押莊對輸贏金額 */
  playerPairDiffAmount: Maybe<Scalars['Float']>;
  /** Region */
  region: Maybe<Scalars['String']>;
  /** 押小金額 */
  smallAmount: Maybe<Scalars['Float']>;
  /** 押小輸贏金額 */
  smallDiffAmount: Maybe<Scalars['Float']>;
  /** 押幸運6金額 */
  super6Amount: Maybe<Scalars['Float']>;
  /** 押幸運6輸贏金額 */
  super6DiffAmount: Maybe<Scalars['Float']>;
  /** 押和金額 */
  tieAmount: Maybe<Scalars['Float']>;
  /** 押和輸贏金額 */
  tieDiffAmount: Maybe<Scalars['Float']>;
  /** 總押注 */
  ...
  user: Maybe<User>;
  /** 輸贏 */
  winLossAmount: Maybe<Scalars['Float']>;
  /** 退水 */
  winReturn: Maybe<Scalars['Float']>;
};

export type BaccaratBetRecordCollection = {
  __typename: 'BaccaratBetRecordCollection';
  /** 總投注量 */
  betTotal: Maybe<Scalars['Float']>;
  /** 目前筆數 */
  currentCount: Maybe<Scalars['Int']>;
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  /** 總輸贏 */
  diffTotal: Maybe<Scalars['Float']>;
  /** 百家押注記錄 */
  records: Maybe<Array<BaccaratBetRecord>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type BaccaratGame = {
  ...
  /** 該局總投注紀錄 */
  baccaratBetRecords: Maybe<BaccaratBetRecordCollection>;
  /** 遊戲房間 */
  baccaratRoom: Maybe<BaccaratRoom>;
  /** Room ID */
  baccaratRoomId: Maybe<Scalars['ID']>;
  /** 押大總金額 */
  bigAmount: Maybe<Scalars['Float']>;
  /** 押大是否贏 */
  bigWin: Maybe<Scalars['Boolean']>;
  /** 開始時間 */
  ...
  dealerAmount: Maybe<Scalars['Float']>;
  /** 莊家牌 */
  dealerCards: Maybe<Array<Scalars['Int']>>;
  /** 莊家是否需要補牌 */
  dealerNeedAnother: Maybe<Scalars['Boolean']>;
  /** 押莊對總金額 */
  dealerPairAmount: Maybe<Scalars['Float']>;
  /** 押莊對是否贏 */
  dealerPairWin: Maybe<Scalars['Boolean']>;
  /** 莊家點數 */
  dealerPoints: Maybe<Scalars['Int']>;
  /** 押莊是否贏 */
  dealerWin: Maybe<Scalars['Boolean']>;
  /** 下注截止時間 */
  endAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 遊戲局號 */
  gameNo: Maybe<Scalars['String']>;
  /** ID */
  id: Scalars['ID'];
  /** 押閒總金額 */
  playerAmount: Maybe<Scalars['Float']>;
  /** 閒家牌 */
  playerCards: Maybe<Array<Scalars['Int']>>;
  /** 玩家人數 */
  playerCounts: Maybe<Scalars['Int']>;
  /** 閒家是否需要補牌 */
  playerNeedAnother: Maybe<Scalars['Boolean']>;
  /** 押閒對總金額 */
  playerPairAmount: Maybe<Scalars['Float']>;
  /** 押閒對是否贏 */
  playerPairWin: Maybe<Scalars['Boolean']>;
  /** 閒家點數 */
  playerPoints: Maybe<Scalars['Int']>;
  /** 押閒是否贏 */
  playerWin: Maybe<Scalars['Boolean']>;
  /** 路單 */
  roadImage: Maybe<Scalars['String']>;
  /** 是否洗牌 */
  shuffle: Maybe<Scalars['Boolean']>;
  /** 押小總金額 */
  smallAmount: Maybe<Scalars['Float']>;
  /** 押小是否贏 */
  smallWin: Maybe<Scalars['Boolean']>;
  /** 開始時間 */
  ...
  super6Amount: Maybe<Scalars['Float']>;
  /** 押幸運6是否贏 */
  super6Win: Maybe<Scalars['Boolean']>;
  /** 押和總金額 */
  tieAmount: Maybe<Scalars['Float']>;
  /** 押和是否贏 */
  tieWin: Maybe<Scalars['Boolean']>;
  /** 總下注量 */
  totalAmount: Maybe<Scalars['Float']>;
  /** 總局數 */
  ...
  totalWinLoss: Maybe<Scalars['Float']>;
  /** 總輸贏 */
  totalWinLossAmount: Maybe<Scalars['Float']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 影片 */
...
export type BaccaratGameCollection = {
  ...
  /** 總下注量 */
  betTotal: Maybe<Scalars['Int']>;
  /** 目前筆數 */
  currentCount: Maybe<Scalars['Int']>;
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  records: Maybe<Array<BaccaratGame>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
  ...
  /** 總輸贏 */
  winLossTotal: Maybe<Scalars['Int']>;
};
...
export type BaccaratMessageCollection = {
  ...
  currentPage: Maybe<Scalars['Int']>;
  /** 訊息 */
  records: Maybe<Array<BaccaratMessage>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type BaccaratRoom = {
  ...
  /** 房間開啟時間 */
  activedAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 警示跑馬燈 */
  ...
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 登入用戶當局下注記錄 */
  currentBaccaratBetRecord: Maybe<CurrentBaccaratBetRecord>;
  /** 當局 */
  currentGame: Maybe<BaccaratGame>;
  /** 現在荷官收禮總金額 */
  currentGirlGiftValue: Maybe<Scalars['Int']>;
  /** 牌路圖片 */
  currentRoadsImage: Maybe<Scalars['String']>;
  /** 莊賠率 */
  dealerOdds: Maybe<Scalars['Float']>;
  /** 莊對賠率 */
  dealerPairOdds: Maybe<Scalars['Float']>;
  /** 房間網域 */
  domain: Maybe<Scalars['String']>;
  /** 是否開啟網頁推播 */
  enablePostWebhook: Maybe<Scalars['Boolean']>;
  /** 是否接收網頁推播 */
  enableReceiveWebhook: Maybe<Scalars['Boolean']>;
  /** 下注區塊顏色G */
  g: Maybe<Scalars['Int']>;
  /** 遊戲結果 */
  gameResults: Maybe<Array<Scalars['String']>>;
  /** 遊戲類型 */
  ...
  /** 本注最大下注量 */
  mainLimit: Maybe<Scalars['Float']>;
  /** 房名 */
  name: Maybe<Scalars['String']>;
  /** 對子最大下注量 */
  pairLimit: Maybe<Scalars['Float']>;
  /** 閒賠率 */
  playerOdds: Maybe<Scalars['Float']>;
  /** 閒對賠率 */
  playerPairOdds: Maybe<Scalars['Float']>;
  /** 下注區塊顏色R */
  r: Maybe<Scalars['Int']>;
  roads: Maybe<Scalars['JSON']>;
  /** 本靴第幾局 */
  roundsInCurrentShuffled: Maybe<Scalars['Int']>;
  /** 倒數秒數剩下幾秒 */
  secondsLeft: Maybe<Scalars['Int']>;
  /** 第幾靴 */
  shuffledCount: Maybe<Scalars['Int']>;
  /** 小賠率 */
  smallOdds: Maybe<Scalars['Float']>;
  /** 房間狀態 */
  status: Maybe<Scalars['String']>;
  /** 主視訊key */
  ...
  /** 幸運6賠率 */
  super6Odds: Maybe<Scalars['Float']>;
  /** 和最大下注量 */
  tieLimit: Maybe<Scalars['Float']>;
  /** 和局賠率 */
  tieOdds: Maybe<Scalars['Float']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 房間會員 */
  ...
  /** 倒數秒數 */
  waitingBetSeconds: Maybe<Scalars['Int']>;
  /** 房間狀態為等待時的顯示文字 */
  waitingText: Maybe<Scalars['String']>;
  /** 網頁推播網址 */
  webhookUrl: Maybe<Scalars['String']>;
  /** 縮放類型 */
  zoomType: Maybe<Scalars['String']>;
};
...
export type BaccaratRoomCollection = {
  ...
  currentPage: Maybe<Scalars['Int']>;
  /** 百家房 */
  records: Maybe<Array<BaccaratRoom>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type Bet = RecordInterface & {
  __typename: 'Bet';
  /** 百家遊戲 */
  baccaratGame: Maybe<BaccaratGame>;
  /** 下注量 */
  betAmount: Maybe<Scalars['Float']>;
  /** 注單編號 */
  betNo: Maybe<Scalars['String']>;
...
export type BetRecord = BetInterface & {
  ...
  /** 是否為莊家 */
  isDealer: Maybe<Scalars['Boolean']>;
  /** Latitude */
  latitude: Maybe<Scalars['Float']>;
  /** Longitude */
  longitude: Maybe<Scalars['Float']>;
  /** 遊戲局 */
  niuGame: Maybe<NiuGame>;
  /** 閒1下注金額 */
  player1Amount: Maybe<Scalars['Int']>;
  /** 閒1輸贏 */
  player1DiffAmount: Maybe<Scalars['Int']>;
  /** 閒1派彩 */
  player1Result: Maybe<Scalars['Int']>;
  /** 閒1下注總金額 */
  player1TotalBet: Maybe<Scalars['Int']>;
  /** 閒2下注金額 */
  player2Amount: Maybe<Scalars['Int']>;
  /** 閒2輸贏 */
  player2DiffAmount: Maybe<Scalars['Int']>;
  /** 閒2派彩 */
  player2Result: Maybe<Scalars['Int']>;
  /** 閒2下注總金額 */
  player2TotalBet: Maybe<Scalars['Int']>;
  /** 閒3下注金額 */
  player3Amount: Maybe<Scalars['Int']>;
  /** 閒3輸贏 */
  player3DiffAmount: Maybe<Scalars['Int']>;
  /** 閒3派彩 */
  player3Result: Maybe<Scalars['Int']>;
  /** 閒3下注總金額 */
  player3TotalBet: Maybe<Scalars['Int']>;
  /** Region */
  region: Maybe<Scalars['String']>;
  /** 房間 */
  room: Maybe<Room>;
  /** 總投注金額 */
  totalBet: Maybe<Scalars['Int']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 用戶 */
  user: Maybe<User>;
...
export type BetResult = {
  ...
  id: Scalars['ID'];
  player1Bet: Maybe<Scalars['Float']>;
  player1Result: Maybe<Scalars['Float']>;
  player2Bet: Maybe<Scalars['Float']>;
  player2Result: Maybe<Scalars['Float']>;
  player3Bet: Maybe<Scalars['Float']>;
  player3Result: Maybe<Scalars['Float']>;
  totalAmount: Maybe<Scalars['Float']>;
};
...
export type Card = {
  ...
  /** 比單張時的數值 */
  singleValue: Maybe<Scalars['String']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 牌面數值 */
...
export type ChargeRecordCollection = {
  ...
  currentPage: Maybe<Scalars['Int']>;
  /** 儲值紀錄 */
  records: Maybe<Array<ChargeRecord>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type CreateAdminBaccaratMessagePayload = {
  ...
  baccaratMessage: Maybe<BaccaratMessage>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId: Maybe<Scalars['String']>;
  errors: Maybe<Array<ModelError>>;
};
...
export type CreateAdminChargePayload = {
  ...
  /** 充值紀錄 */
  chargeRecord: Maybe<ChargeRecord>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId: Maybe<Scalars['String']>;
  /** 錯誤 */
  errors: Maybe<Array<ModelError>>;
...
export type CreateBaccaratBetInput = {
  baccaratRoomId: Scalars['ID'];
  /** 押大金額 */
  bigAmount: Scalars['Float'];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** 押莊金額 */
  dealerAmount: Scalars['Float'];
  /** 押莊對金額 */
  dealerPairAmount: Scalars['Float'];
  /** 裝置資訊 */
  deviceInfo: Scalars['JSON'];
  /** 押閒金額 */
  playerAmount: Scalars['Float'];
  /** 押閒對金額 */
  playerPairAmount: Scalars['Float'];
  /** 押小金額 */
  smallAmount: Scalars['Float'];
  /** 押幸運6金額 */
  super6Amount: Scalars['Float'];
  /** 押和金額 */
  tieAmount: Scalars['Float'];
};
...
export type CreateCsMessagePayload = {
  ...
  clientMutationId: Maybe<Scalars['String']>;
  errors: Maybe<Array<ModelError>>;
  ticketMessage: Maybe<TicketMessageInterface>;
};
...
export type CreatePlayerTransactionPayload = {
  ...
  clientMutationId: Maybe<Scalars['String']>;
  errors: Maybe<Array<ModelError>>;
  playerTransaction: Maybe<PlayerTransaction>;
};
...
export type CreateWithdrawRecordPayload = {
  ...
  clientMutationId: Maybe<Scalars['String']>;
  errors: Maybe<Array<ModelError>>;
  withdrawRecord: Maybe<WithdrawRecord>;
};
...
export type CreateWorldCupRoomPayload = {
  ...
  clientMutationId: Maybe<Scalars['String']>;
  errors: Maybe<Array<ModelError>>;
  worldCupRoom: Maybe<WorldCupRoom>;
};
...
export type CreditChangeRecord = {
  ...
  id: Scalars['ID'];
  /** 變動後額度 */
  newCredit: Maybe<Scalars['Float']>;
  /** 變動後剩餘額度 */
  newCreditLeft: Maybe<Scalars['Float']>;
  /** 變動前額度 */
  prevCredit: Maybe<Scalars['Float']>;
  /** 變動前剩餘額度 */
  prevCreditLeft: Maybe<Scalars['Float']>;
  /** 關聯紀錄 */
  referenceRecord: Maybe<ReferenceRecordInterface>;
  /** 操作者 */
  source: Maybe<SourceInterface>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  /** Agent */
  user: Maybe<User>;
...
export type CreditChangeRecordCollection = {
  ...
  allBetRecordsWinLoss: Maybe<Scalars['Float']>;
  allBetSum: Maybe<Scalars['Float']>;
  allGiftsRecordsSum: Maybe<Scalars['Float']>;
  allGiftsSum: Maybe<Scalars['Float']>;
  allRollbackSum: Maybe<Scalars['Float']>;
  allWinSum: Maybe<Scalars['Float']>;
  currentBetSum: Maybe<Scalars['Float']>;
  /** 目前筆數 */
  currentCount: Maybe<Scalars['Int']>;
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  currentRollbackSum: Maybe<Scalars['Float']>;
  currentWinSum: Maybe<Scalars['Float']>;
  records: Maybe<Array<CreditChangeRecord>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type CurrentBaccaratBetRecord = {
  ...
  totalAmount: Maybe<Scalars['Float']>;
  /** 總派彩 */
  totalDiffAmount: Maybe<Scalars['Float']>;
  /** 總輸贏 */
  winLossAmount: Maybe<Scalars['Float']>;
};
...
export type CurrentNiuniuBetRecord = {
  ...
  /** 閒1下注金額 */
  player1Amount: Maybe<Scalars['Float']>;
  /** 閒1輸贏 */
  player1DiffAmount: Maybe<Scalars['Float']>;
  /** 閒2下注金額 */
  player2Amount: Maybe<Scalars['Float']>;
  /** 閒2輸贏 */
  player2DiffAmount: Maybe<Scalars['Float']>;
  /** 閒3下注金額 */
  player3Amount: Maybe<Scalars['Float']>;
  /** 閒3輸贏 */
  player3DiffAmount: Maybe<Scalars['Float']>;
  /** 總投注金額 */
  totalAmount: Maybe<Scalars['Float']>;
  /** 總輸贏 */
  totalDiffAmount: Maybe<Scalars['Float']>;
...
export type CurrentUserBetRecordCollection = {
  ...
  currentPage: Maybe<Scalars['Int']>;
  diffTotal: Maybe<Scalars['Float']>;
  effectiveBetTotal: Maybe<Scalars['Float']>;
  records: Maybe<Array<RecordInterface>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
  ximaCommission: Maybe<Scalars['Float']>;
  ximaRate: Maybe<Scalars['String']>;
};
...
export type Gift = RecordInterface & ReferenceRecordInterface & {
  ...
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  gift: Maybe<Scalars['String']>;
  giftZhTw: Maybe<Scalars['String']>;
  girl: Maybe<Girl>;
  id: Scalars['ID'];
  /** info */
  info: Maybe<Scalars['JSON']>;
  room: Maybe<BaccaratRoom>;
  type: Maybe<Scalars['String']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  user: Maybe<User>;
...
export type GiftCollection = {
  ...
  allSum: Maybe<Scalars['JSON']>;
  /** 目前筆數 */
  currentCount: Maybe<Scalars['Int']>;
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  currentSum: Maybe<Scalars['JSON']>;
  records: Maybe<Array<Gift>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type Girl = {
  ...
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 房間收禮總額 */
  giftValueForRoom: Maybe<Scalars['Int']>;
  /** 廳 */
  hall: Hall;
  /** 身高 */
  ...
  /** 下班時間 */
  workingEndAt: Maybe<Scalars['String']>;
  /** 上班時間 */
  workingEndAtInHuman: Maybe<Scalars['String']>;
  /** 上班時間 */
  workingStartAt: Maybe<Scalars['String']>;
  /** 上班時間 */
  workingStartAtInHuman: Maybe<Scalars['String']>;
};
...
export type Hall = {
  ...
  lastSignInIp: Maybe<Scalars['String']>;
  /** 大廳荷官 */
  listGirls: Maybe<Array<Girl>>;
  /** 是否封鎖 */
  locked: Maybe<Scalars['Boolean']>;
  /** 最多開房數量 */
  maxRoomsCount: Maybe<Scalars['Int']>;
  /** 名稱 */
  name: Maybe<Scalars['String']>;
  /** 登入次數 */
  signInCount: Maybe<Scalars['Int']>;
...
export type Issue = {
  ...
  id: Scalars['ID'];
  /** 建立時的IP */
  ipInfo: Maybe<Scalars['JSON']>;
  reporter: Maybe<SourceInterface>;
...
export type Mutation = {
  __typename: 'Mutation';
  /** 新增下級代理 */
  addChildAgent: Maybe<AddChildAgentPayload>;
  /** 存入額度 */
  agentDeposit: Maybe<DepositPayload>;
  /** 存入玩家額度 */
  agentDepositUser: Maybe<DepositUserPayload>;
  /** 玩家洗分 */
  agentResetUser: Maybe<AgentResetUserPayload>;
  /** 超級更新玩家 */
  agentUpdateFullUser: Maybe<AgentUpdateFullUserPayload>;
  /** 更新玩家 */
  agentUpdateUser: Maybe<AgentUpdateUserPayload>;
  /** 取出額度 */
  agentWithdraw: Maybe<WithdrawPayload>;
  /** 取出玩家額度 */
  agentWithdrawUser: Maybe<WithdrawUserPayload>;
  /** 百家洗牌 */
  baccaratShuffle: Maybe<BaccaratShufflePayload>;
  /** 下注 */
  bet: Maybe<BetPayload>;
  /** 取消下注 */
  cancelBaccaratBet: Maybe<CancelBaccaratBetPayload>;
  /** 下注倒數 */
  countDown: Maybe<CountDownPayload>;
  /** 新增百家房聊天訊息 */
  createAdminBaccaratMessage: Maybe<CreateAdminBaccaratMessagePayload>;
  /** 手動充值 */
  createAdminCharge: Maybe<CreateAdminChargePayload>;
  /** 新增管理員 */
  createAdminUser: Maybe<CreateAdminUserPayload>;
  /** 新增代理 */
  createAgent: Maybe<CreateAgentPayload>;
  /** 新增公告 */
  createAnnoncement: Maybe<CreateAnnoncementPayload>;
  /** 下注百家 */
  createBaccaratBet: Maybe<CreateBaccaratBetPayload>;
  /** 新增百家聊天訊息 */
  createBaccaratMessage: Maybe<CreateBaccaratMessagePayload>;
  /** 新增百家房 */
  createBaccaratRoom: Maybe<CreateBaccaratRoomPayload>;
  /** 新增牌 */
  createCard: Maybe<CreateCardPayload>;
  /** 新增牌組 */
  createCardSet: Maybe<CreateCardSetPayload>;
  /** 充值 */
  createCharge: Maybe<CreateChargePayload>;
  /** 新增聊天訊息 */
  createChatroomMessage: Maybe<CreateChatroomMessagePayload>;
  /** 新增下線代理 */
  createChild: Maybe<CreateChildPayload>;
  /** 新增下線玩家 */
  createChildUser: Maybe<CreateChildUserPayload>;
  /** 客服回覆訊息 */
  createCsMessage: Maybe<CreateCsMessagePayload>;
  /** 新增荷官 */
  createGirl: Maybe<CreateGirlPayload>;
  /** 新增廳 */
  createHall: Maybe<CreateHallPayload>;
  /** 問題回報 */
  ...
  /** 新增下線代理 */
  createPlatformChild: Maybe<CreatePlatformChildPayload>;
  createPlayerTransaction: Maybe<CreatePlayerTransactionPayload>;
  /** 新增活動 */
  ...
  /** 建立B2B平台 */
  createRootPlatform: Maybe<CreateRootPlatformPayload>;
  /** 添加鏡位 */
  createStream: Maybe<CreateStreamPayload>;
  createStreamer: CreateStreamerPayload;
  /** 新增子帳號 */
  createSubAccount: Maybe<CreateSubAccountPayload>;
  /** 建立限紅組 */
  createTableLimit: Maybe<CreateTableLimitPayload>;
  /** 建立客服聊天訊息 */
  createTicketMessage: Maybe<CreateTicketMessagePayload>;
  /** 下注推筒子 */
  createTongBet: Maybe<TongBetPayload>;
  /** 新增推筒子房 */
  createTongRoom: Maybe<CreateTongRoomPayload>;
  /** 建立試玩玩家 */
  createTrialUser: Maybe<CreateTrialUserPayload>;
  createWalletAddress: Maybe<CreateWalletAddressPayload>;
  /** 申請提現 */
  createWithdrawRecord: Maybe<CreateWithdrawRecordPayload>;
  createWorldCupRoom: Maybe<CreateWorldCupRoomPayload>;
  /** 客服已讀所有訊息 */
  csRead: Maybe<CsReadTicketMessagesPayload>;
  /** 刪除代理 */
  deleteAgent: Maybe<DeleteAgentPayload>;
  /** 刪除百家房 */
  deleteBaccaratRoom: Maybe<DeleteBaccaratRoomPayload>;
  /** 刪除鏡位 */
  deleteStream: Maybe<DeleteStreamPayload>;
  /** 更新子帳號 */
  deleteSubAccount: Maybe<DeleteSubAccountPayload>;
  /** 刪除玩家 */
  deleteUser: Maybe<DeleteUserPayload>;
  /** 百家洗牌 */
  hallBaccaratShuffle: Maybe<HallBaccaratShufflePayload>;
  /** 新增百家房聊天訊息 */
  hallCreateBaccaratMessage: Maybe<HallCreateBaccaratMessagePayload>;
  /** 新增百家房 */
  hallCreateBaccaratRoom: Maybe<HallCreateBaccaratRoomPayload>;
  /** 新增荷官 */
  hallCreateGirl: Maybe<HallCreateGirlPayload>;
  /** 重置所有牌 */
  hallResetBaccaratCards: Maybe<HallResetBaccaratCardsPayload>;
  /** 自動掃描更新百家牌 */
  hallUpdateBaccaratCard: Maybe<HallUpdateBaccaratCardPayload>;
  /** 百家開牌 */
  hallUpdateBaccaratCards: Maybe<HallUpdateBaccaratCardsPayload>;
  /** 修改百家牌局 */
  hallUpdateBaccaratGameResult: Maybe<HallUpdateBaccaratGameResultPayload>;
  /** 更新百家房 */
  hallUpdateBaccaratRoom: Maybe<HallUpdateBaccaratRoomPayload>;
  /** 更新百家遊戲資訊 */
  hallUpdateBaccaratRoundStatus: Maybe<HallUpdateBaccaratRoundPayload>;
  /** 百家補牌 */
  hallUpdateBaccaratThirdCard: Maybe<HallUpdateBaccaratThirdCardPayload>;
  /** 更新荷官 */
  hallUpdateGirl: Maybe<HallUpdateGirlPayload>;
  /** 加入排莊序列 */
  joinQueue: Maybe<JoinQueuePayload>;
  likeGirl: Maybe<LikeGirlPayload>;
  /** 喜歡直播主 */
  likeStreamer: LikeStreamerPayload;
  /** 登出 */
  logout: Maybe<LogoutPayload>;
  /** 呼吸 */
  pingRoom: Maybe<PingRoomPayload>;
  /** 自動掃描更新百家牌 */
  resetBaccaratCards: Maybe<ResetBaccaratCardsPayload>;
  /** 重置最後一次洗牌 */
  resetLastShuffle: Maybe<ResetLastShufflePayload>;
  /** 送百家禮物 */
  sendBaccaratGift: Maybe<SendBaccaratGiftPayload>;
  /** 送禮物 */
  sendGift: Maybe<SendGiftPayload>;
  /** 送直播主禮物 */
  sendStreamerGift: SendStreamerGiftPayload;
  /** 發送驗證碼 */
  sendVerificationCode: Maybe<SendVerificationCodePayload>;
  /** 註冊 */
  signUp: Maybe<SignUpPayload>;
  toggleAgentBots: Maybe<ToggleAgentBotsPayload>;
  toggleEnableEditProfit: Maybe<ToggleEnableEditProfitPayload>;
  toggleEnableStreamer: ToggleEnableStreamerPayload;
  /** 廳開關 */
  toggleHall: Maybe<ToggleHallPayload>;
  /** 封鎖或解開代理 */
  toggleLock: Maybe<ToggleLockPayload>;
  toggleLockdown: Maybe<ToggleLockdownPayload>;
  /** 封鎖或解開玩家 */
  toggleUserLock: Maybe<ToggleUserLockPayload>;
  /** 筒子房洗牌 */
  tongShuffle: Maybe<TongShufflePayload>;
  /** 轉移下層代理 */
  transferChildren: Maybe<TransferChildrenPayload>;
  unlikeGirl: Maybe<UnlikeGirlPayload>;
  /** 不喜歡直播主 */
  unlikeStreamer: UnlikeStreamerPayload;
  /** 更新廣告 */
  updateAds: Maybe<UpdateAdsPayload>;
  /** 更新代理 */
  updateAgent: Maybe<UpdateAgentPayload>;
  /** 更新代理廣告 */
  updateAgentAd: Maybe<UpdateAgentAdPayload>;
  /** 更新代理密碼 */
  updateAgentPassword: Maybe<UpdateAgentPasswordPayload>;
  /** 更新公告 */
  updateAnnoncement: Maybe<UpdateAnnoncementPayload>;
  /** 自動掃描更新百家牌 */
  updateBaccaratCard: Maybe<UpdateBaccaratCardPayload>;
  /** 百家開牌 */
  updateBaccaratCards: Maybe<UpdateBaccaratCardsPayload>;
  /** 修改百家牌局 */
  updateBaccaratGameResult: Maybe<UpdateBaccaratGameResultPayload>;
  /** 更新百家房 */
  updateBaccaratRoom: Maybe<UpdateBaccaratRoomPayload>;
  /** 更新百家房位置 */
  updateBaccaratRoomPosition: Maybe<UpdateBaccaratRoomPositionPayload>;
  /** 更新百家遊戲資訊 */
  updateBaccaratRoundStatus: Maybe<UpdateBaccaratRoundPayload>;
  /** 百家補牌 */
  updateBaccaratThirdCard: Maybe<UpdateBaccaratThirdCardPayload>;
  updateBotAgentUsernames: Maybe<UpdateBotAgentUsernamesPayload>;
  updateBotTime: Maybe<UpdateBotTimePayload>;
  /** 更新回調網址設定 */
  updateCallbacks: Maybe<UpdateCallbacksPayload>;
  /** 更新玩家牌面 */
  updateCard: Maybe<UpdateCardPayload>;
  /** 批次更新玩家牌面 */
  updateCards: Maybe<UpdateCardsPayload>;
  /** 編輯下線代理 */
  updateChild: Maybe<UpdateChildPayload>;
  /** 修改骰子 */
  updateDice: Maybe<UpdateDicePayload>;
  updateDisabledChatUsernames: Maybe<UpdateDisabledChatUsernamesPayload>;
  /** 超級更新下線 */
  updateFullChild: Maybe<UpdateFullChildPayload>;
  /** 更新遊戲狀態 */
  updateGameStatus: Maybe<UpdateGameStatusPayload>;
  /** 更新荷官 */
  updateGirl: Maybe<UpdateGirlPayload>;
  /** 更新廳 */
  updateHall: Maybe<UpdateHallPayload>;
  /** 上線狀態 */
  updateLastSeen: Maybe<UpdateLastSeenPayload>;
  /** 修改代理 */
  updatePlatform: Maybe<UpdatePlatformPayload>;
  /** 修改玩家限紅 */
  updatePlayerTableLimit: Maybe<UpdatePlayerTableLimitPayload>;
  /** 更新彩池 */
  ...
  /** 更新房間狀態 */
  updateRoomStatus: Maybe<UpdateRoomStatusPayload>;
  /** 更新跑馬燈文字 */
  updateRoomText: Maybe<UpdateRoomTextPayload>;
  /** 更新用戶設定 */
  updateSettings: Maybe<UpdateSettingsPayload>;
  /** 更新直播主資訊 */
  updateStreamer: UpdateStreamerPayload;
  updateStreamerDisabled: UpdateStreamerDisabledPayload;
  /** 設定上下線 */
  updateStreamerOnline: UpdateStreamerOnlinePayload;
  /** 更新直播主房間 */
  updateStreamerRoom: UpdateStreamerRoomPayload;
  updateStreamerRoomText: Maybe<UpdateStreamerRoomTextPayload>;
  /** 更新主播班表 */
  updateStreamersImage: Maybe<UpdateStreamersImagePayload>;
  /** 更新子帳號 */
  updateSubAccount: Maybe<UpdateSubAccountPayload>;
  /** 客服更新ISSUE */
  updateTicket: Maybe<UpdateTicketPayload>;
  /** 更新筒子房牌 */
  updateTongCards: Maybe<UpdateTongCardsPayload>;
  /** 更新推筒子房 */
  updateTongRoom: Maybe<UpdateTongRoomPayload>;
  /** 更新筒子房狀態 */
  updateTongRound: Maybe<UpdateTongRoundPayload>;
  /** 更新提現紀錄狀態 */
  updateWithdrawStatus: Maybe<UpdateWithdrawStatusPayload>;
  updateWorldCupRoom: Maybe<UpdateWorldCupRoomPayload>;
  /** 用戶已讀所有訊息 */
  userRead: Maybe<UserReadTicketMessagesPayload>;
  /** 驗證驗證碼 */
  verifyCode: Maybe<VerifyCodePayload>;
  /** 進房歡迎訊息 */
  welcomeMessage: Maybe<WelcomeMessagePayload>;
};
...
export type NiuGame = {
  __typename: 'NiuGame';
  /** 遊戲下注紀錄 */
  betRecords: Maybe<Array<BetRecord>>;
  /** 建立時間 */
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 我目前的投注 */
  currentBet: Maybe<Scalars['Int']>;
  /** 莊家 */
  dealer: Maybe<Player>;
  /** 本局莊家剩下幾局 */
  dealerCountLeft: Maybe<Scalars['Int']>;
  /** 本局排莊莊家 */
  dealerId: Maybe<Scalars['ID']>;
  /** 骰子點數 */
  dice: Maybe<Scalars['Int']>;
  /** 遊戲局號 */
  gameNo: Maybe<Scalars['String']>;
  /** 是否已有結果 */
  hasResult: Maybe<Scalars['Boolean']>;
  ...
  id: Scalars['ID'];
  /** 我的遊戲紀錄 */
  myBetRecords: Maybe<Array<BetRecord>>;
  /** 閒1 */
...
export type NiuniuStatistics = {
  ...
  dealerWins: Maybe<Scalars['Int']>;
  id: Scalars['ID'];
  player1Wins: Maybe<Scalars['Int']>;
  player2Wins: Maybe<Scalars['Int']>;
  player3Wins: Maybe<Scalars['Int']>;
};
...
export type OnNiuniuBetChangedPayload = {
  ...
  currentNiuniuBetRecord: Maybe<CurrentNiuniuBetRecord>;
};
...
export type OnNiuniuDealerQueueChangedPayload = {
  ...
  dealerQueue: Maybe<Array<QueueUser>>;
};
...
export type OnNiuniuTotalBetChangedPayload = {
  ...
  /** 該局玩家總下注 */
  currentGameBetTotal: Maybe<Scalars['JSON']>;
};
...
export type OnTicketsStatusChangedPayload = {
  ...
  currentTickets: Maybe<Array<Ticket>>;
};
...
export type Platform = {
  __typename: 'Platform';
  /** 最大下注 */
  baccaratMaxBet: Maybe<Scalars['Float']>;
  /** 最小下注 */
  baccaratMinBet: Maybe<Scalars['Float']>;
  /** 免轉錢包下注回調 */
  ...
  /** 上層平台 */
  parentPlatform: Maybe<Platform>;
  players: Maybe<UserCollection>;
  /** 玩家數 */
  playersCount: Maybe<Scalars['Int']>;
  /** 平台密鑰 */
  secureToken: Maybe<Scalars['String']>;
  /** 是否自行管理Token */
  selfManageToken: Maybe<Scalars['Boolean']>;
  /** 帳號狀態 */
  status: Maybe<Scalars['String']>;
  /** tree */
  tree: Maybe<Scalars['JSON']>;
...
export type PlatformUserWinLoss = {
  ...
  baccaratEffectiveAmount: Maybe<Scalars['Float']>;
  /** 百家禮金 */
  baccaratGiftsAmount: Maybe<Scalars['Float']>;
  /** 百家筆數 */
  baccaratRecordsCount: Maybe<Scalars['Float']>;
  /** 百家總金額 */
  baccaratTotalAmount: Maybe<Scalars['Float']>;
  /** 百家勝點 */
  baccaratWinAmount: Maybe<Scalars['Float']>;
  /** 輸贏 */
  baccaratWinLoss: Maybe<Scalars['Float']>;
  /** 輸贏比 */
  baccaratWinLossRate: Maybe<Scalars['String']>;
  ...
  niuniuEffectiveAmount: Maybe<Scalars['Float']>;
  /** 牛牛禮金 */
  niuniuGiftsAmount: Maybe<Scalars['Float']>;
  /** 牛牛筆數 */
  niuniuRecordsCount: Maybe<Scalars['Float']>;
  /** 百家總金額 */
  niuniuTotalAmount: Maybe<Scalars['Float']>;
  /** 牛牛勝點 */
  niuniuWinAmount: Maybe<Scalars['Float']>;
  /** 輸贏 */
  niuniuWinLoss: Maybe<Scalars['Float']>;
  /** 輸贏比 */
  niuniuWinLossRate: Maybe<Scalars['String']>;
  /** 推筒子投注金額 */
  tongBetAmount: Maybe<Scalars['Float']>;
  /** 推筒子有效投注 */
  tongEffectiveAmount: Maybe<Scalars['Float']>;
  /** 推筒子禮金 */
  tongGiftsAmount: Maybe<Scalars['Float']>;
  /** 推筒子筆數 */
  tongRecordsCount: Maybe<Scalars['Float']>;
  /** 推筒子總金額 */
  tongTotalAmount: Maybe<Scalars['Float']>;
  /** 推筒子勝點 */
  tongWinAmount: Maybe<Scalars['Float']>;
  /** 輸贏 */
  tongWinLoss: Maybe<Scalars['Float']>;
  /** 輸贏比 */
  tongWinLossRate: Maybe<Scalars['String']>;
  /** 小計投注金額 */
  totalBetAmount: Maybe<Scalars['Float']>;
  /** 小計有效投注 */
  totalEffectiveAmount: Maybe<Scalars['Float']>;
  /** 小計禮金 */
  totalGiftsAmount: Maybe<Scalars['Float']>;
  /** 總筆數 */
...
export type PlatformUserWinLossCollection = {
  ...
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  records: Maybe<Array<Scalars['JSON']>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type PlatformWinLoss = {
  ...
  baccaratWinLossRate: Maybe<Scalars['String']>;
  /** 下層代理報表 */
  childrenReports: Maybe<Array<PlatformWinLoss>>;
  id: Scalars['ID'];
  /** 牛牛投注金額 */
  niuniuBetAmount: Maybe<Scalars['Float']>;
  /** 牛牛有效投注 */
  ...
  platform: Maybe<Platform>;
  /** 主播禮物金額 */
  streamerGiftsAmount: Maybe<Scalars['Float']>;
  /** 推筒子投注金額 */
  tongBetAmount: Maybe<Scalars['Float']>;
  /** 推筒子有效投注 */
  tongEffectiveAmount: Maybe<Scalars['Float']>;
  ...
  totalWinLossRate: Maybe<Scalars['String']>;
  /** 玩家輸贏報表 */
  usersReports: Maybe<Array<PlatformUserWinLoss>>;
};

export type Player = {
  __typename: 'Player';
  /** 最佳組合 */
  bestCards: Maybe<Array<Scalars['Int']>>;
  /** 下注量 */
  betAmount: Maybe<Scalars['Int']>;
  /** 牌面1 */
  card1: Maybe<Scalars['Int']>;
  /** 牌面2 */
  card2: Maybe<Scalars['Int']>;
  /** 牌面3 */
  card3: Maybe<Scalars['Int']>;
  /** 牌面4 */
  card4: Maybe<Scalars['Int']>;
  /** 牌面5 */
  card5: Maybe<Scalars['Int']>;
  /** ID */
  id: Scalars['ID'];
  /** 是否贏 */
...
export type PlayerTransaction = {
  ...
  /** 玩家出入金前餘額 */
  balanceBefore: Maybe<Scalars['Int']>;
  /** 建立時間 */
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  /** ID */
  id: Scalars['ID'];
  ...
  ipAddress: Maybe<Scalars['String']>;
  /** 轉單站點單號或是TXID */
  remoteTransactionNo: Maybe<Scalars['String']>;
  /** 本站單號 */
...
export type PlayerTransactionCollection = {
  ...
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  records: Maybe<Array<PlayerTransaction>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type Profile = {
  __typename: 'Profile';
  /** 累计流水 */
  accumulatedBet: Maybe<Scalars['Int']>;
  /** 还需流水 */
  accumulatedBetLeft: Maybe<Scalars['Int']>;
  /** Auth token */
  authToken: Maybe<Scalars['String']>;
  /** 頭像 */
  avatar: Maybe<Scalars['String']>;
  ...
  /** 是否可充值 */
  canCharge: Maybe<Scalars['Boolean']>;
  /** 是否可提領 */
  ...
  /** 發出時間 */
  currentTime: Maybe<Scalars['ISO8601DateTime']>;
  /** 紅利 */
  dividend: Maybe<Scalars['Float']>;
  /** 追龍顆數 */
  dragonCount: Maybe<Scalars['Int']>;
  /** 有效投注總計 */
  effectiveBetTotal: Maybe<Scalars['Float']>;
  /** Email */
  email: Maybe<Scalars['String']>;
  /** 是否隱藏贏點 */
  hideWinPoints: Maybe<Scalars['Boolean']>;
  /** ID */
  id: Scalars['ID'];
  /** 上層代理 */
  introducer: Maybe<User>;
  /** 試玩者 */
  ...
  /** 本月下層會員 */
  monthlyReferralsCount: Maybe<Scalars['Int']>;
  /** 本月反水收益 */
  monthlyReferralsRevenue: Maybe<Scalars['Float']>;
  /** nickname */
  nickname: Maybe<Scalars['String']>;
  /** 牛牛最打下注 */
  niuniuMaxBet: Maybe<Scalars['Float']>;
  /** 牛牛最小下注 */
  niuniuMinBet: Maybe<Scalars['Float']>;
  /** 平台是否關閉成人連結 */
  platformDisableAdult: Maybe<Scalars['Boolean']>;
  /** 平台是否關閉成人連結 */
  platformDisableCustomerService: Maybe<Scalars['Boolean']>;
  /** 推薦碼 */
  referralCode: Maybe<Scalars['String']>;
  /** 下層會員 */
  referrals: Maybe<Array<User>>;
  /** 下層會員人數 */
  referralsCount: Maybe<Scalars['Int']>;
  /** 與本週差 */
  revenueDiffFromThisMonth: Maybe<Scalars['Float']>;
  /** 與本週差 */
  revenueDiffFromThisWeek: Maybe<Scalars['Float']>;
  /** 與昨日差 */
  revenueDiffFromYesterday: Maybe<Scalars['Float']>;
  /** 身分 */
  role: Maybe<Scalars['String']>;
  /** 用戶設定 */
  settings: Maybe<Scalars['JSON']>;
  /** 限紅最大值 */
  tableLimitMax: Maybe<Scalars['Int']>;
  /** 限紅最小值 */
  tableLimitMin: Maybe<Scalars['Int']>;
  /** 本日下層會員數 */
  todayReferralsCount: Maybe<Scalars['Int']>;
  /** 本日反水收益 */
  todayReferralsRevenue: Maybe<Scalars['Float']>;
  /** 有效投注 */
  totalEffectiveAmount: Maybe<Scalars['Float']>;
  /** 有效投注 */
  totalEffectiveXimaAmount: Maybe<Scalars['Float']>;
  /** 全部反水收益 */
  totalReferralsRevenue: Maybe<Scalars['Float']>;
  /** 累積勝點 */
  totalWinAmount: Maybe<Scalars['Float']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  ...
  /** 本週下層會員 */
  weeklyReferralsCount: Maybe<Scalars['Int']>;
  /** 本週反水收益 */
  weeklyReferralsRevenue: Maybe<Scalars['Float']>;
  /** 贏上限 */
  winLimit: Maybe<Scalars['Int']>;
  /** 退水 */
  ximaTotal: Maybe<Scalars['Float']>;
  /** 退水類型 */
  ximaWay: Maybe<Scalars['String']>;
};
...
export type ProfitChangeRecord = {
  ...
  actionerName: Maybe<Scalars['String']>;
  /** 建立時間 */
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  /** ID */
  id: Scalars['ID'];
  newShareProfitRate: Maybe<Scalars['Float']>;
  newTableLimits: Maybe<Array<Scalars['String']>>;
  newXimaRate: Maybe<Scalars['Float']>;
  prevShareProfitRate: Maybe<Scalars['Float']>;
  prevTableLimits: Maybe<Array<Scalars['String']>>;
  prevXimaRate: Maybe<Scalars['Float']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
};
...
export type ProfitChangeRecordCollection = {
  ...
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  records: Maybe<Array<ProfitChangeRecord>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type Promotion = {
  ...
  /** 條件與回饋 */
  conditionAndOffer: Maybe<Scalars['JSON']>;
  /** 建立時間 */
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 結束時間 */
  endAt: Maybe<Scalars['ISO8601DateTime']>;
...
export type Query = {
  __typename: 'Query';
  /** 所有正在開放的百家樂房間 */
  activeBaccaratRooms: Maybe<Array<BaccaratRoom>>;
  /** 房間 */
  activeRoom: Maybe<Room>;
  /** 所有正在開放的房間 */
  activeRooms: Maybe<Array<Room>>;
  /** 筒子房 */
  activeTongRooms: Maybe<Array<TongRoom>>;
  activeWorldCupRoom: Maybe<WorldCupRoom>;
  activeWorldCupRooms: Maybe<Array<WorldCupRoom>>;
  adminHalls: Maybe<HallCollection>;
  adminPlayerTransactions: Maybe<PlayerTransactionCollection>;
  /** 管理員 */
  adminUsers: Maybe<AdminUserCollection>;
  agent: Maybe<Agent>;
  agentAd: Maybe<Scalars['String']>;
  agentChildren: Maybe<AgentCollection>;
  /** 代理額度變動記錄 */
  agentCreditChangeRecords: Maybe<Array<CreditChangeRecord>>;
  agentDecendantsUsers: Maybe<UserCollection>;
  /** 送禮紀錄 */
  agentGiftRecords: Maybe<SendGiftRecordCollection>;
  agentRanking: Maybe<Scalars['JSON']>;
  agentSubAccounts: Maybe<AgentCollection>;
  agentUsers: Maybe<UserCollection>;
  agentUsersReport: Maybe<Scalars['JSON']>;
  /** 代理輸贏報表 */
  agentWinLoss: Maybe<AgentWinLoss>;
  /** 代理 */
  agents: Maybe<AgentCollection>;
  agentsReport: Maybe<Scalars['JSON']>;
  /** 所有房間的人數 */
  allRoomTypeUsersCount: Maybe<Scalars['JSON']>;
  /** 公告列表 */
  annoncements: Maybe<AnnoncementCollection>;
  /** 百家下注紀錄 */
  baccaratBetRecord: Maybe<BaccaratBetRecord>;
  /** 百家遊戲 */
  baccaratGame: Maybe<BaccaratGame>;
  /** 遊戲結果 */
  baccaratGameResults: Maybe<Array<Scalars['String']>>;
  baccaratGames: Maybe<BaccaratGameCollection>;
  /** 牌路統計 */
  baccaratHistory: Maybe<Scalars['JSON']>;
  /** 百家房間訊息 */
  baccaratMessages: Maybe<BaccaratMessageCollection>;
  /** 百家房 */
  baccaratRoom: Maybe<BaccaratRoom>;
  /** 所有百家房 */
  baccaratRooms: Maybe<BaccaratRoomCollection>;
  /** Bet record */
  betRecord: Maybe<BetRecord>;
  botAgentUsernames: Scalars['String'];
  botEndTime: Scalars['String'];
  botStartTime: Scalars['String'];
  /** 所有牌組 */
  cardSets: Maybe<Array<CardSet>>;
  /** 所有儲值紀錄 */
  chargeRecords: Maybe<ChargeRecordCollection>;
  childAgentWinLossReports: Maybe<Array<Agent>>;
  /** 餘額變化記錄 */
  creditChangeRecords: Maybe<Array<CreditChangeRecord>>;
  /** 登入管理員 */
  currentAdmin: Maybe<AdminProfile>;
  currentAgent: Maybe<Agent>;
  currentAvailableTickets: Maybe<Array<Ticket>>;
  /** 登入用戶當局下注記錄 */
  currentBaccaratBetRecord: Maybe<CurrentBaccaratBetRecord>;
  /** 百家當下遊戲 */
  currentBaccaratGame: Maybe<BaccaratGame>;
  currentGame: Maybe<NiuGame>;
  /** 登入廳 */
  currentHall: Maybe<Hall>;
  /** 登入用戶當局下注紀錄 */
  currentNiuniuBetRecord: Maybe<CurrentNiuniuBetRecord>;
  /** 牛牛當下遊戲 */
  currentNiuniuGame: Maybe<NiuGame>;
  currentPlatform: Maybe<Platform>;
  /** 指定上層平台下的所有平台 */
  currentPlatformChildren: Maybe<PlatformCollection>;
  currentStreamer: Streamer;
  /** 最近的客服問題 */
  currentTicket: Maybe<Ticket>;
  /** 登入用戶當局下注記錄 */
  currentTongBetRecord: Maybe<CurrentTongBetRecord>;
  /** 百家當下遊戲 */
  currentTongGame: Maybe<TongGame>;
  /** 登入用戶 */
  currentUser: Maybe<User>;
  /** 登入玩家投注記錄 */
  currentUserBetRecords: Maybe<CurrentUserBetRecordCollection>;
  /** 排莊序列 */
  dealerQueue: Maybe<Array<QueueUser>>;
  descendantAgents: Maybe<Array<Agent>>;
  disabledChatUsernames: Maybe<Scalars['String']>;
  enableEditProfit: Maybe<Scalars['Boolean']>;
  enableStreamer: Maybe<Scalars['Boolean']>;
  getCard: Maybe<Card>;
  /** 送禮紀錄 */
  giftRecords: Maybe<GiftCollection>;
  girl: Girl;
  /** 所有荷官 */
  girls: Maybe<GirlCollection>;
  /** 廳房間 */
  hallActiveBaccaratRooms: Maybe<Array<BaccaratRoom>>;
  hallBaccaratGames: Maybe<BaccaratGameCollection>;
  /** 百家房間訊息 */
  hallBaccaratMessages: Maybe<BaccaratMessageCollection>;
  /** 百家房 */
  hallBaccaratRoom: Maybe<BaccaratRoom>;
  /** 所有百家房 */
  hallBaccaratRooms: Maybe<BaccaratRoomCollection>;
  /** 送禮紀錄 */
  hallGiftRecords: Maybe<GiftCollection>;
  /** 所有荷官 */
  hallGirls: Maybe<GirlCollection>;
  hallRoomGirl: Maybe<Girl>;
  /** 所有廳 */
  halls: Maybe<Array<Hall>>;
  /** 問題回報 */
  issue: Maybe<Issue>;
  /** 問題回報 */
  issues: Maybe<IssueCollection>;
  leaderboard: Maybe<Scalars['JSON']>;
  listHalls: Maybe<Array<Hall>>;
  /** 即時下注 */
  liveBaccaratBetRecords: Maybe<BaccaratBetRecordCollection>;
  loadingAds: Maybe<Array<Scalars['String']>>;
  lockdown: Maybe<Scalars['Boolean']>;
  /** 房間訊息 */
  messages: Maybe<MessageCollection>;
  /** 我的記錄 */
  myRecords: Maybe<RecordCollection>;
  newAgentUsersReport: Maybe<Scalars['JSON']>;
  newAgentsReport: Maybe<Scalars['JSON']>;
  /** 新路 */
  newBaccaratGameResults: Maybe<Scalars['JSON']>;
  newStreamerRanking: Maybe<Array<Streamer>>;
  niuGame: Maybe<NiuGame>;
  /** 牛牛最近牌路統計 */
  niuniuRecentGamesStatistics: Maybe<NiuniuStatistics>;
  /** 線上用戶 */
  onlineUsers: Maybe<Array<User>>;
  /** 平台 */
  platform: Maybe<Platform>;
  /** 指定上層平台下的所有平台 */
  platformChildren: Maybe<PlatformCollection>;
  /** 對押記錄 */
  platformDoubleBets: Array<DoubleBet>;
  platformGifts: Maybe<GiftCollection>;
  /** 平台玩家輸贏 */
  platformUserWinLoss: Maybe<PlatformUserWinLossCollection>;
  /** 代理輸贏報表 */
  platformWinLoss: Maybe<PlatformWinLoss>;
  playerGameRecords: Maybe<PlayerGameRecordCollection>;
  /** 玩家出入金紀錄 */
  playerTransactions: Maybe<PlayerTransactionCollection>;
  pool: Maybe<Scalars['Int']>;
  /** 登入用戶 */
  profile: Maybe<Profile>;
  profitChangeHistory: Maybe<ProfitChangeRecordCollection>;
  /** 所有活動 */
  promotions: Maybe<PromotionCollection>;
  ranking: Maybe<Scalars['JSON']>;
  /** true */
  recentNiuGames: Maybe<Array<NiuGame>>;
  roadsAndImage: Maybe<Scalars['JSON']>;
  /** 房間 */
  room: Maybe<Room>;
  roomGirl: Maybe<Girl>;
  /** 房間人數 */
  roomOnlineUsers: Maybe<Array<User>>;
  roomText: Maybe<Scalars['String']>;
  /** 所有房間 */
  rooms: Maybe<RoomCollection>;
  /** 所有上層平台 */
  rootPlatforms: Maybe<PlatformCollection>;
  searchAgentBetRecords: Maybe<SearchAgentBetRecords>;
  /** 代理額度變動記錄 */
  searchAgentCreditChangeRecords: Maybe<Array<CreditChangeRecord>>;
  searchDoubleBet: Maybe<Scalars['JSON']>;
  /** 代理額度變動記錄 */
  searchUserCreditChangeRecords: Maybe<CreditChangeRecordCollection>;
  /** 送禮紀錄 */
  sendGiftRecords: Maybe<SendGiftRecordCollection>;
  streamer: Streamer;
  streamerGiftRecords: SendGiftRecordCollection;
  streamerLastSessionRanking: Array<RankingRow>;
  streamerRanking: Array<RankingRow>;
  streamerThisWeekSessions: Array<StreamerSession>;
  streamers: Array<Streamer>;
  streamersImage: Maybe<Scalars['String']>;
  /** 分組限紅 */
  tableLimits: Maybe<TableLimitCollection>;
  /** 客服訊息 */
  ticketMessages: Maybe<TicketMessageCollection>;
  /** 下注紀錄 */
  tongBetRecord: Maybe<TongBetRecord>;
  /** 筒子局 */
  tongGame: Maybe<TongGame>;
  /** 推筒子房 */
  tongRoom: Maybe<TongRoom>;
  /** 所有推筒子房 */
  tongRooms: Maybe<TongRoomCollection>;
  /** 下注紀錄查詢 */
  userBetRecord: Maybe<BetRecord>;
  /** 單一用戶下注紀錄 */
  userBetRecords: Maybe<BetRecordCollection>;
  /** 單一用戶儲值紀錄 */
  userChargeRecords: Maybe<ChargeRecordCollection>;
  /** 代理額度變動記錄 */
  userCreditChangeRecords: Maybe<CreditChangeRecordCollection>;
  userRanking: Maybe<Scalars['JSON']>;
  /** 用戶記錄 */
  userRecords: Maybe<RecordCollection>;
  /** 會員列表 */
  users: Maybe<UserCollection>;
  /** 錢包資訊 */
  wallet: Maybe<Wallet>;
  walletAddresses: Maybe<WalletAddressCollection>;
  /** 所有提現紀錄 */
  withdrawRecords: Maybe<WithdrawRecordCollection>;
  worldCupRooms: Maybe<WorldCupRoomCollection>;
};
...
export type Room = {
  ...
  b: Maybe<Scalars['Int']>;
  /** 玩家是否可排隊當莊 */
  canBeDealer: Maybe<Scalars['Boolean']>;
  /** 關房時間 */
  ...
  currentNiuniuBetRecord: Maybe<CurrentNiuniuBetRecord>;
  /** 排莊最小餘額限制 */
  dealerMinBalance: Maybe<Scalars['Int']>;
  /** 莊家勝利局數 */
  dealerWinsCount: Maybe<Scalars['Int']>;
  /** 水錢 */
  fee: Maybe<Scalars['Int']>;
  /** 下注區塊顏色G */
  g: Maybe<Scalars['Int']>;
  ...
  /** 最近8場遊戲結果 */
  lastEightGames: Maybe<Array<NiuGame>>;
  /** 最大注上限 */
  maxBet: Maybe<Scalars['Int']>;
  /** 單門最大下注量 */
  maxSinglePlayerBet: Maybe<Scalars['Int']>;
  /** 最小注下限 */
  minBet: Maybe<Scalars['Int']>;
  /** 房間名 */
  name: Maybe<Scalars['String']>;
  /** 牛7賠率 */
  odds7: Maybe<Scalars['Int']>;
  /** 牛8賠率 */
  odds8: Maybe<Scalars['Int']>;
  /** 牛9賠率 */
  odds9: Maybe<Scalars['Int']>;
  /** 牛牛賠率 */
  odds20: Maybe<Scalars['Int']>;
  /** 五公賠率 */
  odds50: Maybe<Scalars['Int']>;
  /** 線上人數 */
  onlineUsersCount: Maybe<Scalars['Int']>;
  /** 開牌秒數 */
  openingSeconds: Maybe<Scalars['Int']>;
  /** 莊家勝利局數 */
  player1WinsCount: Maybe<Scalars['Int']>;
  /** 莊家勝利局數 */
  player2WinsCount: Maybe<Scalars['Int']>;
  /** 莊家勝利局數 */
  player3WinsCount: Maybe<Scalars['Int']>;
  /** 排隊序列 */
  queueUsers: Maybe<Array<User>>;
  /** 下注區塊顏色R */
  r: Maybe<Scalars['Int']>;
  /** 房間狀態 */
  status: Maybe<Scalars['String']>;
  ...
  streams: Maybe<Array<Stream>>;
  /** 累積下注金額 */
  totalBetAmount: Maybe<Scalars['Int']>;
  /** 所有局數收到的水錢總和 */
  totalBetFeeAmount: Maybe<Scalars['Int']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 下注倒數秒數 */
  waitingBetSeconds: Maybe<Scalars['Int']>;
...
export type SearchAgentBetRecords = {
  ...
  currentPage: Maybe<Scalars['Int']>;
  /** 目前頁數莊家總下注 */
  currentPageDealer: Maybe<Scalars['Float']>;
  /** 目前頁數莊對總下注 */
  currentPageDealerPair: Maybe<Scalars['Float']>;
  /** 目前頁數閒家總下注 */
  currentPagePlayer: Maybe<Scalars['Float']>;
  /** 目前頁數閒對總下注 */
  currentPagePlayerPair: Maybe<Scalars['Float']>;
  /** 目前頁數幸運6總下注 */
  currentPageSuper6: Maybe<Scalars['Float']>;
  /** 目前頁數和局總下注 */
  currentPageTie: Maybe<Scalars['Float']>;
  /** 目前頁數總下注 */
  currentPageTotalBet: Maybe<Scalars['Float']>;
  /** 目前頁數總勝點 */
  currentPageTotalWinAmount: Maybe<Scalars['Float']>;
  /** 目前頁數總輸贏 */
  currentPageWinLoss: Maybe<Scalars['Float']>;
  /** 目前頁數總退水 */
  currentPageWinReturn: Maybe<Scalars['Float']>;
  /** 玩家下注記錄 */
  records: Maybe<Array<BetInterface>>;
  /** 總投注 */
  totalBet: Maybe<Scalars['Float']>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 目前頁數莊家總下注 */
  totalPageDealer: Maybe<Scalars['Float']>;
  /** 目前頁數莊對總下注 */
  totalPageDealerPair: Maybe<Scalars['Float']>;
  /** 目前頁數閒家總下注 */
  totalPagePlayer: Maybe<Scalars['Float']>;
  /** 目前頁數閒對總下注 */
  totalPagePlayerPair: Maybe<Scalars['Float']>;
  /** 目前頁數幸運6總下注 */
  totalPageSuper6: Maybe<Scalars['Float']>;
  /** 目前頁數和局總下注 */
  totalPageTie: Maybe<Scalars['Float']>;
  /** 目前頁數總下注 */
  totalPageTotalBet: Maybe<Scalars['Float']>;
  /** 目前頁數總勝點 */
  totalPageTotalWinAmount: Maybe<Scalars['Float']>;
  /** 目前頁數總輸贏 */
  totalPageWinLoss: Maybe<Scalars['Float']>;
  /** 目前頁數總退水 */
  totalPageWinReturn: Maybe<Scalars['Float']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
  /** 總輸贏 */
  winLoss: Maybe<Scalars['Float']>;
...
export type Subscription = {
  ...
  /** 百家下注狀態變化 */
  onBaccaratBetChanged: Maybe<OnBaccaratBetChangedPayload>;
  /** 百家房新訊息 */
  onBaccaratNewMessage: Maybe<BaccaratMessage>;
  /** 百家房間狀態變化 */
  onBaccaratRoomChanged: Maybe<OnBaccaratRoomChangedPayload>;
  /** 牛牛房新訊息 */
  onNewMessage: Maybe<Message>;
  /** 新客服訊息 */
  onNewTicketMessage: Maybe<TicketMessageInterface>;
  /** 牛牛下注狀態變化 */
  onNiuniuBetChanged: Maybe<OnNiuniuBetChangedPayload>;
  /** 牛牛排莊序列變化 */
  onNiuniuDealerQueueChanged: Maybe<OnNiuniuDealerQueueChangedPayload>;
  /** 牛牛遊戲狀態變化 */
  onNiuniuGameChanged: Maybe<OnNiuniuGameChangedPayload>;
  /** 牛牛總下注狀態變化 */
  onNiuniuTotalBetChanged: Maybe<OnNiuniuTotalBetChangedPayload>;
  /** 用戶通知 */
  onNotify: Maybe<OnNotifyPayload>;
  /** 線上用戶變化 */
  onOnlineUsersChanged: Maybe<OnOnlineUsersChangedPayload>;
  /** 個人資料變化 */
  onProfileChanged: Maybe<OnProfileChangedPayload>;
  /** 牛牛房間狀態變化 */
  onRoomChanged: Maybe<OnRoomChangedPayload>;
  /** 訂閱所有我的客服案件變化 */
  onTicketsStatusChanged: Maybe<OnTicketsStatusChangedPayload>;
  /** 推筒子房間狀態變化 */
  onTongRoomChanged: Maybe<OnTongRoomChangedPayload>;
  /** 線上用戶變化 */
  onUserOnlineChanged: Maybe<Array<User>>;
};
...
export type TableLimitCollection = {
  ...
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  records: Maybe<Array<TableLimit>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type Ticket = {
  ...
  cs: Maybe<AdminUser>;
  /** 客服未讀訊息數量 */
  csUnreadCount: Maybe<Scalars['Int']>;
  /** 備註 */
  description: Maybe<Scalars['String']>;
  /** ID */
  id: Scalars['ID'];
  lastMessage: Maybe<Scalars['String']>;
  messages: Maybe<Array<TicketMessageInterface>>;
  /** 狀態 */
  status: Maybe<Scalars['String']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
  ...
  user: Maybe<User>;
  /** 用戶未讀訊息數量 */
  userUnreadCount: Maybe<Scalars['Int']>;
};
...
export type TicketMessageCollection = {
  ...
  currentPage: Maybe<Scalars['Int']>;
  /** 客服訊息 */
  records: Maybe<Array<TicketMessageInterface>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type TongBetRecord = BetInterface & {
  ...
  createdAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 派彩後餘額 */
  creditAfterWin: Maybe<Scalars['Int']>;
  /** 幣別 */
  currency: Maybe<Scalars['String']>;
  /** 總輸贏 */
  diff: Maybe<Scalars['Float']>;
...
export type TongGame = {
  ...
  dealerCards: Maybe<Array<Scalars['Int']>>;
  /** 莊家點數 */
  dealerPoints: Maybe<Scalars['Float']>;
  /** 遊戲局號 */
  gameNo: Maybe<Scalars['String']>;
  /** ID */
  id: Scalars['ID'];
  ...
  player1Amount: Maybe<Scalars['Int']>;
  /** 閒1牌 */
  player1Cards: Maybe<Array<Scalars['Int']>>;
  /** 閒1點數 */
  player1Points: Maybe<Scalars['Float']>;
  /** 閒1是否贏 */
  player1Win: Maybe<Scalars['Boolean']>;
  /** 閒2是否贏 */
  player2Amount: Maybe<Scalars['Int']>;
  /** 閒2牌 */
  player2Cards: Maybe<Array<Scalars['Int']>>;
  /** 閒2點數 */
  player2Points: Maybe<Scalars['Float']>;
  /** 閒2是否贏 */
  player2Win: Maybe<Scalars['Boolean']>;
  /** 閒3是否贏 */
  player3Amount: Maybe<Scalars['Int']>;
  /** 閒3牌 */
  player3Cards: Maybe<Array<Scalars['Int']>>;
  /** 閒3點數 */
  player3Points: Maybe<Scalars['Float']>;
  /** 閒3是否贏 */
  player3Win: Maybe<Scalars['Boolean']>;
  /** 洗牌 */
  shuffle: Maybe<Scalars['Boolean']>;
  /** 開局時間 */
  startedAt: Maybe<Scalars['ISO8601DateTime']>;
...
export type TongRoom = {
  ...
  currentTongGame: Maybe<TongGame>;
  /** 遊戲結果 */
  gameResults: Maybe<Scalars['JSON']>;
  /** 荷官 */
  girl: Maybe<Girl>;
  /** ID */
  id: Scalars['ID'];
...
export type UpdateBotAgentUsernamesPayload = {
  ...
  botAgentUsernames: Maybe<Scalars['String']>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId: Maybe<Scalars['String']>;
};
...
export type UpdateBotTimePayload = {
  ...
  botEndTime: Maybe<Scalars['String']>;
  botStartTime: Maybe<Scalars['String']>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId: Maybe<Scalars['String']>;
};
...
export type UpdateStreamerOnlinePayload = {
  ...
  /** A unique identifier for the client performing the mutation. */
  clientMutationId: Maybe<Scalars['String']>;
  currentStreamer: Maybe<Streamer>;
};
...
export type User = SourceInterface & {
  ...
  creditBalance: Maybe<Scalars['Float']>;
  /** 信用額度餘額 */
  creditBalanceLeft: Maybe<Scalars['Float']>;
  /** 最近一次登入時間 */
  currentSignInAt: Maybe<Scalars['ISO8601DateTime']>;
  /** 最後登入IP */
  currentSignInIp: Maybe<Scalars['JSON']>;
  /** Email */
  email: Maybe<Scalars['String']>;
  /** 是否在介面隱藏 */
  hide: Maybe<Scalars['Boolean']>;
  ...
  winLimit: Maybe<Scalars['Int']>;
  /** 輸贏報表 */
  winLossReport: Maybe<UserWinLoss>;
  /** 洗碼方式 */
  ximaWay: Maybe<Scalars['String']>;
};
...
export type WalletAddressCollection = {
  ...
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  records: Maybe<Array<WalletAddress>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type WithdrawRecord = {
  ...
  user: Maybe<User>;
  /** HASH */
  withdrawNo: Maybe<Scalars['String']>;
};
...
export type WithdrawRecordCollection = {
  ...
  currentPage: Maybe<Scalars['Int']>;
  /** 提現紀錄 */
  records: Maybe<Array<WithdrawRecord>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
...
export type WorldCupRoom = {
  ...
  streamer: Maybe<Streamer>;
  title: Maybe<Scalars['String']>;
  translatedStatus: Maybe<Scalars['String']>;
  /** 更新時間 */
  updatedAt: Maybe<Scalars['ISO8601DateTime']>;
};
...
export type WorldCupRoomCollection = {
  ...
  /** 目前所在頁 */
  currentPage: Maybe<Scalars['Int']>;
  records: Maybe<Array<WorldCupRoom>>;
  /** 總數 */
  totalCount: Maybe<Scalars['Int']>;
  /** 總頁數 */
  totalPages: Maybe<Scalars['Int']>;
